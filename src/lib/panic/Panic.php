...
class Panic {
   ...
   * @param int    $code
   */
  public static function with_reason(int $line, string $file, string $reason, int $code = 1): void {
   ...
   * @param mixed  $thing
   */
  public static function if_reached(int $line, string $file, $thing = null): void {
    if ($thing === null) {
